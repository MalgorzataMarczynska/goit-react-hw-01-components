# Some example React components (application based on CRA) for user's profile, statistics, friendlist with active/inactive status and table with transaction history.
